...
<!-- Note this would also leave out the affiliation "External" -->  
     ...
     <xsl:choose>
        <xsl:when test="not(creator_institution = '')"><affiliation><xsl:apply-templates select="creator_institution"/></affiliation></xsl:when>
      <xsl:otherwise>
...
<!--    <xsl:choose>
 ...
 <xsl:if test="not(book_commercial_publisher ='')">
...
<!--    <xsl:choose>
    ...
    <xsl:choose>
     ...
     <!-- HERDC information - book -->
     <xsl:if test="not(book_o_commercial_publisher ='')">
...
<dateIssued>
    ...
    <xsl:choose>
     ...
     <xsl:if test="not(chapter_book_commercial_publisher ='')">
...
<dateIssued>
    ...
    <xsl:choose>
      <xsl:when test="chapter_book_o_edition">
       ...
       <!-- HERDC information - book of chapter -->
     <xsl:if test="not(chapter_book_o_commercial_publisher ='')">
...
<identifier type="scopus">
 ...
 <xsl:if test="not(conference_paper_peer_reviewed ='')">
<note type="peer_reviewed"><xsl:apply-templates select="conference_paper_peer_reviewed"/></note> 
 ...
 <xsl:if test="not(conference_nat_internat ='')">
      ...
      <xsl:when test="conference_proceedings_issn">
        <identifier type="issn">
			...
			<name type="conference">
			     <namePart>    
         <xsl:choose>
      <xsl:when test="conference_number"><xsl:apply-templates select="conference_number"/>, </xsl:when>
    </xsl:choose>
    <xsl:apply-templates select="conference_name"/>, 
             <xsl:choose>
      <xsl:when test="conference_location"><xsl:apply-templates select="conference_location"/>, </xsl:when>
    </xsl:choose>
                 <xsl:choose>
      <xsl:when test="conference_date"><xsl:apply-templates select="conference_date"/></xsl:when>
    </xsl:choose> 
                </namePart>
			</name>
      </xsl:when>
  ...
  <!-- ................................ Conference Paper O .......................................-->          
    ...
    <!-- Conference Paper O Language -->    
     ...
     <!-- Conference Paper O Total Pages -->    
        <xsl:choose>
      <xsl:when test="conference_o_page_from">
		    <physicalDescription>
			    <form authority="marcform">print</form>
			    <extent>
...
<identifier type="scopus">
 ...
 <xsl:if test="not(conference_paper_o_peer_reviewed ='')">
<note type="peer_reviewed"><xsl:apply-templates select="conference_paper_o_peer_reviewed"/></note> 
 ...
 <xsl:if test="not(conference_o_nat_internat ='')">
     ...
     <xsl:choose>
      <xsl:when test="conference_proceedings_o_issn">
		...
		<name type="conference">
			     <namePart>    
         <xsl:choose>
      <xsl:when test="conference_o_number"><xsl:apply-templates select="conference_o_number"/>, </xsl:when>
    </xsl:choose>
    <xsl:apply-templates select="conference_o_name"/>, 
             <xsl:choose>
      <xsl:when test="conference_o_location"><xsl:apply-templates select="conference_o_location"/>, </xsl:when>
    </xsl:choose>
                 <xsl:choose>
      <xsl:when test="conference_o_date"><xsl:apply-templates select="conference_o_date"/></xsl:when>
    </xsl:choose> 
                </namePart>
		</name>
      </xsl:when>
...
<identifier type="scopus">
 ...
 <xsl:if test="not(journal_article_peer_reviewed ='')">
...
<dateIssued>
 ...
 <xsl:if test="not(journal_ERA_id ='')">
...
<identifier type="scopus">
 ...
 <xsl:if test="not(journal_article_o_peer_reviewed ='')">
...
<dateIssued>
           ...
           <!-- HERDC information - Journal ERA id -->
 <xsl:if test="not(journal_o_ERA_id ='')">
...
<genre authority="local">creative works - exhibition</genre>
    ...
    <!-- Creative Works - Exhibition Location / Dates / Holding Exhibition Title  -->
		<relatedItem>
			     <titleInfo>
                    ...
                    <partNumber>
                    Number of works contributed:<xsl:apply-templates select="exhibition_number_items_contributed"/> of <xsl:apply-templates select="exhibition_total_number_items"/> total works 
 	                </partNumber>
 	           	 </titleInfo>
		</relatedItem>
    ...
    <xsl:choose>
      <xsl:when test="exhibition_abstract">
            <abstract>
	        <xsl:apply-templates select="exhibition_type_of_work_description"/>: <xsl:apply-templates select="exhibition_abstract"/> 
            </abstract>
      </xsl:when>
    </xsl:choose> 
...
<!--    <xsl:choose>
     ...
     <!-- Creative Works - Exhibition Holding Exhibition Title -->
     <!-- The title of the exhibition that this Authors work(exhibition) is a part (subset) of -->
<!--    <xsl:choose>
      <xsl:when test="holding_exhibition_title">
        <titleInfo>
          <title>
           	<xsl:apply-templates select="holding_exhibition_title"/>
	        </title>
        </titleInfo>
      </xsl:when>
    </xsl:choose> -->
...
<genre authority="local">creative works - published work</genre>
    ...
    <xsl:choose>
      <xsl:when test="published_work_abstract">
        <abstract>
	        <xsl:apply-templates select="published_work_type_of_work_description"/>: <xsl:apply-templates select="published_work_abstract"/> 
        </abstract>
      </xsl:when>
    </xsl:choose>
...
<dateOther type="releaseDate">
     ...
     <!-- Creative Works - Recorded Work Distribution Medium, total seconds -->
      <physicalDescription>
    ...
    <xsl:choose>
      <xsl:when test="recorded_work_abstract">
        <abstract>
	        <xsl:apply-templates select="recorded_work_type_of_work_description"/>: <xsl:apply-templates select="recorded_work_abstract"/> 
        </abstract>
      </xsl:when>
    </xsl:choose> 
    
     <!-- Creative Works - Recorded Work Type of Work Description -->
  <!--  <xsl:choose>
      <xsl:when test="recorded_work_type_of_work_description">
            <abstract>
...
<!--<affiliation>
     ...
     <xsl:choose>
        <xsl:when test="not(//*[local-name()=$institution] = '')"><affiliation><xsl:apply-templates select="//*[local-name()=$institution]"/></affiliation></xsl:when>
      <xsl:otherwise>
