...
<!-- <xsl:if test="creator_affiliation  ='External'"><affiliation></affiliation></xsl:if> -->
<!-- <xsl:if test="creator_affiliation  ='Pre-UWS'"><affiliation>Pre-UWS</affiliation></xsl:if> -->
<!-- <xsl:if test="creator_affiliation  ='Pre-UWS'"><affiliation></affiliation></xsl:if> -->   

<!-- <xsl:if test="creator_institution  ='University of Western Sydney'"><affiliation>University of Western Sydney</affiliation></xsl:if> 
<xsl:if test="not(creator_institution  ='University of Western Sydney')"><affiliation>non UWS</affiliation></xsl:if> --> 
   ...
   <xsl:choose>
      <xsl:when test="chapter_book_title">
         <relatedItem type="host">
            ...
            <xsl:choose>
               <xsl:when test="chapter_isbn_e">
                  <identifier type="isbn_e">
	                 <xsl:apply-templates select="chapter_isbn_e"/>
                  </identifier>
               </xsl:when>
            </xsl:choose>
    ...
    <xsl:choose>
      <xsl:when test="year">
		<originInfo>
			<place>
				<placeTerm type="text">
	        <xsl:apply-templates select="chapter_place_published"/>
</placeTerm>
</place>
<publisher>
...
<dateIssued>
    ...
    <xsl:choose>
      <xsl:when test="chapter_editors">
		<name type="personal">
			<namePart>
	        <xsl:apply-templates select="chapter_editors"/>
            </namePart>
			<role>
    ...
    <xsl:apply-templates select="*[starts-with(local-name(),'chapter_editors_')]"/>        
...
<!--                  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX These next few should be in relatedItem/part above XXXXXXXXXXXXXXXXXXXXXXXXXXX -->    
 ...
 <!--   <xsl:choose>
  ...
  <xsl:template match="*[starts-with(local-name(),'chapter_editors_')]">
	<xsl:variable name="num" select="substring-after(name(),'chapter_editors_')"/>
	<xsl:variable name="chapter_editors" select="concat('chapter_editors_',$num)"/>
		<name type="personal">
			<namePart>
	<xsl:value-of select="."/>
            </namePart>
