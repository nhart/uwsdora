...
<xsl:if test="SEO_code  ='970122'">970122 - Expanding Knowledge in Philosophy and Religious Studies</xsl:if> 
  ...
  <!-- Year - see individual Publish Year -->
    ...
    <xsl:choose>
      ...
      <xsl:variable name="cfirst" select= "translate(creator_first_name, translate(creator_first_name, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ. ', ''), '')"/>
<name type="personal">
<namePart>
     <xsl:apply-templates select="creator_last_name"/>, <xsl:value-of select= "$cfirst"/>
</namePart>
        <role>
...
<!--    <xsl:choose>
      <xsl:when test="conferece_paper_scopus_id">
<identifier type="scopus">
...
<!--    <xsl:choose>
      <xsl:when test="conferece_paper_o_scopus_id">
<identifier type="scopus">
...
<name type="personal">
<namePart>
	  <xsl:value-of select="."/>, <xsl:value-of select="translate(//*[local-name()=$first_name], translate(//*[local-name()=$first_name], 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ. ', ''), '')"/>
</namePart>
        <role>
           <roleTerm authority="marcrelator" type="text">author</roleTerm>
        </role>
