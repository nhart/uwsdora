...
<!-- David added 655 -->
		...
		<xsl:call-template name="specialItem76X-78X"/>
		</xsl:for-each>
		
<!-- David added 787 -->
<xsl:if test="not($restype='book')">
<xsl:if test="not($restype='Report')">
<xsl:if test="not($restype='journal article')">
<xsl:if test="not($restype='THESIS')">
<relatedItem type="host">
		<xsl:for-each select="marc:datafield[@tag=772]|marc:datafield[@tag=773]|marc:datafield[@tag=787]|marc:datafield[@tag=020]">
...
<xsl:if test="$restype='journal article'">
<relatedItem type="host">
		<xsl:for-each select="marc:datafield[@tag=772]|marc:datafield[@tag=773]|marc:datafield[@tag=787]|marc:datafield[@tag=022]">
				<xsl:call-template name="relatedItem76X-78X"/>
...
<xsl:for-each select="marc:subfield[@code='e']">
			<namePart type="cited">editor</namePart>
			<role>
