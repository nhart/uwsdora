...
<xsl:if test="FOR_code = '0101 - Pure Mathematics'">0101 - Pure Mathematics</xsl:if>
<xsl:if test="FOR_code = '0102 - Applied Mathematics'">0102 - Applied Mathematics</xsl:if>
<xsl:if test="FOR_code = '0103 - Numerical and Computational Mathematics'">0103 - Numerical and Computational Mathematics</xsl:if>
<xsl:if test="FOR_code = '0104 - Statistics'">0104 - Statistics</xsl:if>
<xsl:if test="FOR_code = '0105 - Mathematical Physics'">0105 - Mathematical Physics</xsl:if>
<xsl:if test="FOR_code = '0199 - Other Mathematical Sciences'">0199 - Other Mathematical Sciences</xsl:if>
<xsl:if test="FOR_code = '0201 - Astronomical and Space Sciences'">0201 - Astronomical and Space Sciences</xsl:if>
<xsl:if test="FOR_code = '0202 - Atomic, Molecular, Nuclear, Particle and Plasma Physics'">0202 - Atomic, Molecular, Nuclear, Particle and Plasma Physics</xsl:if>
<xsl:if test="FOR_code = '0203 - Classical Physics'">0203 - Classical Physics</xsl:if>
<xsl:if test="FOR_code = '0204 - Condensed Matter Physics'">0204 - Condensed Matter Physics</xsl:if>
<xsl:if test="FOR_code = '0205 - Optical Physics'">0205 - Optical Physics</xsl:if>
<xsl:if test="FOR_code = '0206 - Quantum Physics'">0206 - Quantum Physics</xsl:if>
<xsl:if test="FOR_code = '0299 - Other Physical Sciences'">0299 - Other Physical Sciences</xsl:if>
<xsl:if test="FOR_code = '0301 - Analytical Chemistry'">0301 - Analytical Chemistry</xsl:if>
<xsl:if test="FOR_code = '0302 - Inorganic Chemistry'">0302 - Inorganic Chemistry</xsl:if>
<xsl:if test="FOR_code = '0303 - Macromolecular and Materials Chemistry'">0303 - Macromolecular and Materials Chemistry</xsl:if>
<xsl:if test="FOR_code = '0304 - Medicinal and Biomolecular Chemistry'">0304 - Medicinal and Biomolecular Chemistry</xsl:if>
<xsl:if test="FOR_code = '0305 - Organic Chemistry'">0305 - Organic Chemistry</xsl:if>
<xsl:if test="FOR_code = '0306 - Physical Chemistry (incl. Structural)'">0306 - Physical Chemistry (incl. Structural)</xsl:if>
<xsl:if test="FOR_code = '0307 - Theoretical and Computational Chemistry'">0307 - Theoretical and Computational Chemistry</xsl:if>
<xsl:if test="FOR_code = '0399 - Other Chemical Sciences'">0399 - Other Chemical Sciences</xsl:if>
<xsl:if test="FOR_code = '0401 - Atmospheric Sciences'">0401 - Atmospheric Sciences</xsl:if>
<xsl:if test="FOR_code = '0402 - Geochemistry'">0402 - Geochemistry</xsl:if>
<xsl:if test="FOR_code = '0403 - Geology'">0403 - Geology</xsl:if>
<xsl:if test="FOR_code = '0404 - Geophysics'">0404 - Geophysics</xsl:if>
<xsl:if test="FOR_code = '0405 - Oceanography'">0405 - Oceanography</xsl:if>
<xsl:if test="FOR_code = '0406 - Physical Geography and Environmental Geoscience'">0406 - Physical Geography and Environmental Geoscience</xsl:if>
<xsl:if test="FOR_code = '0499 - Other Earth Sciences'">0499 - Other Earth Sciences</xsl:if>
<xsl:if test="FOR_code = '0501 - Ecological Applications'">0501 - Ecological Applications</xsl:if>
<xsl:if test="FOR_code = '0502 - Environmental Science and Management'">0502 - Environmental Science and Management</xsl:if>
<xsl:if test="FOR_code = '0503 - Soil Sciences'">0503 - Soil Sciences</xsl:if>
<xsl:if test="FOR_code = '0599 - Other Environmental Sciences'">0599 - Other Environmental Sciences</xsl:if>
<xsl:if test="FOR_code = '0601 - Biochemistry and Cell Biology'">0601 - Biochemistry and Cell Biology</xsl:if>
<xsl:if test="FOR_code = '0602 - Ecology'">0602 - Ecology</xsl:if>
<xsl:if test="FOR_code = '0603 - Evolutionary Biology'">0603 - Evolutionary Biology</xsl:if>
<xsl:if test="FOR_code = '0604 - Genetics'">0604 - Genetics</xsl:if>
<xsl:if test="FOR_code = '0605 - Microbiology'">0605 - Microbiology</xsl:if>
<xsl:if test="FOR_code = '0606 - Physiology'">0606 - Physiology</xsl:if>
<xsl:if test="FOR_code = '0607 - Plant Biology'">0607 - Plant Biology</xsl:if>
<xsl:if test="FOR_code = '0608 - Zoology'">0608 - Zoology</xsl:if>
<xsl:if test="FOR_code = '0699 - Other Biological Sciences'">0699 - Other Biological Sciences</xsl:if>
<xsl:if test="FOR_code = '0701 - Agriculture, Land and Farm Management'">0701 - Agriculture, Land and Farm Management</xsl:if>
<xsl:if test="FOR_code = '0702 - Animal Production'">0702 - Animal Production</xsl:if>
<xsl:if test="FOR_code = '0703 - Crop and Pasture Production'">0703 - Crop and Pasture Production</xsl:if>
<xsl:if test="FOR_code = '0704 - Fisheries Sciences'">0704 - Fisheries Sciences</xsl:if>
<xsl:if test="FOR_code = '0705 - Forestry Sciences'">0705 - Forestry Sciences</xsl:if>
<xsl:if test="FOR_code = '0706 - Horticultural Production'">0706 - Horticultural Production</xsl:if>
<xsl:if test="FOR_code = '0707 - Veterinary Sciences'">0707 - Veterinary Sciences</xsl:if>
<xsl:if test="FOR_code = '0799 - Other Agricultural and Veterinary Sciences'">0799 - Other Agricultural and Veterinary Sciences</xsl:if>
<xsl:if test="FOR_code = '0801 - Artificial Intelligence and Image Processing'">0801 - Artificial Intelligence and Image Processing</xsl:if>
<xsl:if test="FOR_code = '0802 - Computation Theory and Mathematics'">0802 - Computation Theory and Mathematics</xsl:if>
<xsl:if test="FOR_code = '0803 - Computer Software'">0803 - Computer Software</xsl:if>
<xsl:if test="FOR_code = '0804 - Data Format'">0804 - Data Format</xsl:if>
<xsl:if test="FOR_code = '0805 - Distributed Computing'">0805 - Distributed Computing</xsl:if>
<xsl:if test="FOR_code = '0806 - Information Systems'">0806 - Information Systems</xsl:if>
<xsl:if test="FOR_code = '0807 - Library and Information Studies'">0807 - Library and Information Studies</xsl:if>
<xsl:if test="FOR_code = '0899 - Other Information and Computing Sciences'">0899 - Other Information and Computing Sciences</xsl:if>
<xsl:if test="FOR_code = '0901 - Aerospace Engineering'">0901 - Aerospace Engineering</xsl:if>
<xsl:if test="FOR_code = '0902 - Automotive Engineering'">0902 - Automotive Engineering</xsl:if>
<xsl:if test="FOR_code = '0903 - Biomedical Engineering'">0903 - Biomedical Engineering</xsl:if>
<xsl:if test="FOR_code = '0904 - Chemical Engineering'">0904 - Chemical Engineering</xsl:if>
<xsl:if test="FOR_code = '0905 - Civil Engineering'">0905 - Civil Engineering</xsl:if>
<xsl:if test="FOR_code = '0906 - Electrical and Electronic Engineering'">0906 - Electrical and Electronic Engineering</xsl:if>
<xsl:if test="FOR_code = '0907 - Environmental Engineering'">0907 - Environmental Engineering</xsl:if>
<xsl:if test="FOR_code = '0908 - Food Sciences'">0908 - Food Sciences</xsl:if>
<xsl:if test="FOR_code = '0909 - Geomatic Engineering'">0909 - Geomatic Engineering</xsl:if>
<xsl:if test="FOR_code = '0910 - Manufacturing Engineering'">0910 - Manufacturing Engineering</xsl:if>
<xsl:if test="FOR_code = '0911 - Maritime Engineering'">0911 - Maritime Engineering</xsl:if>
<xsl:if test="FOR_code = '0912 - Materials Engineering'">0912 - Materials Engineering</xsl:if>
<xsl:if test="FOR_code = '0913 - Mechanical Engineering'">0913 - Mechanical Engineering</xsl:if>
<xsl:if test="FOR_code = '0914 - Resources Engineering and Extractive Metallurgy'">0914 - Resources Engineering and Extractive Metallurgy</xsl:if>
<xsl:if test="FOR_code = '0915 - Interdisciplinary Engineering'">0915 - Interdisciplinary Engineering</xsl:if>
<xsl:if test="FOR_code = '0999 - Other Engineering'">0999 - Other Engineering</xsl:if>
<xsl:if test="FOR_code = '1001 - Agricultural Biotechnology'">1001 - Agricultural Biotechnology</xsl:if>
<xsl:if test="FOR_code = '1002 - Environmental Biotechnology'">1002 - Environmental Biotechnology</xsl:if>
<xsl:if test="FOR_code = '1003 - Industrial Biotechnology'">1003 - Industrial Biotechnology</xsl:if>
<xsl:if test="FOR_code = '1004 - Medical Biotechnology'">1004 - Medical Biotechnology</xsl:if>
<xsl:if test="FOR_code = '1005 - Communications Technologies'">1005 - Communications Technologies</xsl:if>
<xsl:if test="FOR_code = '1006 - Computer Hardware'">1006 - Computer Hardware</xsl:if>
<xsl:if test="FOR_code = '1007 - Nanotechnology'">1007 - Nanotechnology</xsl:if>
<xsl:if test="FOR_code = '1099 - Other Technology'">1099 - Other Technology</xsl:if>
<xsl:if test="FOR_code = '1101 - Medical Biochemistry and Metabolomics'">1101 - Medical Biochemistry and Metabolomics</xsl:if>
<xsl:if test="FOR_code = '1102 - Cardiorespiratory Medicine and Haematology'">1102 - Cardiorespiratory Medicine and Haematology</xsl:if>
<xsl:if test="FOR_code = '1103 - Clinical Sciences'">1103 - Clinical Sciences</xsl:if>
<xsl:if test="FOR_code = '1104 - Complementary and Alternative Medicine'">1104 - Complementary and Alternative Medicine</xsl:if>
<xsl:if test="FOR_code = '1105 - Dentistry'">1105 - Dentistry</xsl:if>
<xsl:if test="FOR_code = '1106 - Human Movement and Sports Science'">1106 - Human Movement and Sports Science</xsl:if>
<xsl:if test="FOR_code = '1107 - Immunology'">1107 - Immunology</xsl:if>
<xsl:if test="FOR_code = '1108 - Medical Microbiology'">1108 - Medical Microbiology</xsl:if>
<xsl:if test="FOR_code = '1109 - Neurosciences'">1109 - Neurosciences</xsl:if>
<xsl:if test="FOR_code = '1110 - Nursing'">1110 - Nursing</xsl:if>
<xsl:if test="FOR_code = '1111 - Nutrition and Dietetics'">1111 - Nutrition and Dietetics</xsl:if>
<xsl:if test="FOR_code = '1112 - Oncology and Carcinogenesis'">1112 - Oncology and Carcinogenesis</xsl:if>
<xsl:if test="FOR_code = '1113 - Ophthalmology and Optometry'">1113 - Ophthalmology and Optometry</xsl:if>
<xsl:if test="FOR_code = '1114 - Paediatrics and Reproductive Medicine'">1114 - Paediatrics and Reproductive Medicine</xsl:if>
<xsl:if test="FOR_code = '1115 - Pharmacology and Pharmaceutical Sciences'">1115 - Pharmacology and Pharmaceutical Sciences</xsl:if>
<xsl:if test="FOR_code = '1116 - Medical Physiology'">1116 - Medical Physiology</xsl:if>
<xsl:if test="FOR_code = '1117 - Public Health and Health Services'">1117 - Public Health and Health Services</xsl:if>
<xsl:if test="FOR_code = '1199 - Other Medical and Health Sciences'">1199 - Other Medical and Health Sciences</xsl:if>
<xsl:if test="FOR_code = '1201 - Architecture'">1201 - Architecture</xsl:if>
<xsl:if test="FOR_code = '1202 - Building'">1202 - Building</xsl:if>
<xsl:if test="FOR_code = '1203 - Design Practice and Management'">1203 - Design Practice and Management</xsl:if>
<xsl:if test="FOR_code = '1204 - Engineering Design'">1204 - Engineering Design</xsl:if>
<xsl:if test="FOR_code = '1205 - Urban and Regional Planning'">1205 - Urban and Regional Planning</xsl:if>
<xsl:if test="FOR_code = '1299 - Other Built Environment and Design'">1299 - Other Built Environment and Design</xsl:if>
<xsl:if test="FOR_code = '1301 - Education Systems'">1301 - Education Systems</xsl:if>
<xsl:if test="FOR_code = '1302 - Curriculum and Pedagogy'">1302 - Curriculum and Pedagogy</xsl:if>
<xsl:if test="FOR_code = '1303 - Specialist Studies in Education'">1303 - Specialist Studies in Education</xsl:if>
<xsl:if test="FOR_code = '1399 - Other Education'">1399 - Other Education</xsl:if>
<xsl:if test="FOR_code = '1401 - Economic Theory'">1401 - Economic Theory</xsl:if>
<xsl:if test="FOR_code = '1402 - Applied Economics'">1402 - Applied Economics</xsl:if>
<xsl:if test="FOR_code = '1403 - Econometrics'">1403 - Econometrics</xsl:if>
<xsl:if test="FOR_code = '1499 - Other Economics'">1499 - Other Economics</xsl:if>
<xsl:if test="FOR_code = '1501 - Accounting, Auditing and Accountability'">1501 - Accounting, Auditing and Accountability</xsl:if>
<xsl:if test="FOR_code = '1502 - Banking, Finance and Investment'">1502 - Banking, Finance and Investment</xsl:if>
<xsl:if test="FOR_code = '1503 - Business and Management'">1503 - Business and Management</xsl:if>
<xsl:if test="FOR_code = '1504 - Commercial Services'">1504 - Commercial Services</xsl:if>
<xsl:if test="FOR_code = '1505 - Marketing'">1505 - Marketing</xsl:if>
<xsl:if test="FOR_code = '1506 - Tourism'">1506 - Tourism</xsl:if>
<xsl:if test="FOR_code = '1507 - Transportation and Freight Services'">1507 - Transportation and Freight Services</xsl:if>
<xsl:if test="FOR_code = '1599 - Other Commerce, Management, Tourism and Services'">1599 - Other Commerce, Management, Tourism and Services</xsl:if>
<xsl:if test="FOR_code = '1601 - Anthropology'">1601 - Anthropology</xsl:if>
<xsl:if test="FOR_code = '1602 - Criminology'">1602 - Criminology</xsl:if>
<xsl:if test="FOR_code = '1603 - Demography'">1603 - Demography</xsl:if>
<xsl:if test="FOR_code = '1604 - Human Geography'">1604 - Human Geography</xsl:if>
<xsl:if test="FOR_code = '1605 - Policy and Administration'">1605 - Policy and Administration</xsl:if>
<xsl:if test="FOR_code = '1606 - Political Science'">1606 - Political Science</xsl:if>
<xsl:if test="FOR_code = '1607 - Social Work'">1607 - Social Work</xsl:if>
<xsl:if test="FOR_code = '1608 - Sociology'">1608 - Sociology</xsl:if>
<xsl:if test="FOR_code = '1699 - Other Studies in Human Society'">1699 - Other Studies in Human Society</xsl:if>
<xsl:if test="FOR_code = '1701 - Psychology'">1701 - Psychology</xsl:if>
<xsl:if test="FOR_code = '1702 - Cognitive Sciences'">1702 - Cognitive Sciences</xsl:if>
<xsl:if test="FOR_code = '1799 - Other Psychology and Cognitive Sciences'">1799 - Other Psychology and Cognitive Sciences</xsl:if>
<xsl:if test="FOR_code = '1801 - Law'">1801 - Law</xsl:if>
<xsl:if test="FOR_code = '1802 - Maori Law'">1802 - Maori Law</xsl:if>
<xsl:if test="FOR_code = '1899 - Other Law and Legal Studies'">1899 - Other Law and Legal Studies</xsl:if>
<xsl:if test="FOR_code = '1901 - Art Theory and Criticism'">1901 - Art Theory and Criticism</xsl:if>
<xsl:if test="FOR_code = '1902 - Film, Television and Digital Media'">1902 - Film, Television and Digital Media</xsl:if>
<xsl:if test="FOR_code = '1903 - Journalism and Professional Writing'">1903 - Journalism and Professional Writing</xsl:if>
<xsl:if test="FOR_code = '1904 - Performing Arts and Creative Writing'">1904 - Performing Arts and Creative Writing</xsl:if>
<xsl:if test="FOR_code = '1905 - Visual Arts and Crafts'">1905 - Visual Arts and Crafts</xsl:if>
<xsl:if test="FOR_code = '1999 - Other Studies in Creative Arts and Writing'">1999 - Other Studies in Creative Arts and Writing</xsl:if>
<xsl:if test="FOR_code = '2001 - Communication and Media Studies'">2001 - Communication and Media Studies</xsl:if>
<xsl:if test="FOR_code = '2002 - Cultural Studies'">2002 - Cultural Studies</xsl:if>
<xsl:if test="FOR_code = '2003 - Language Studies'">2003 - Language Studies</xsl:if>
<xsl:if test="FOR_code = '2004 - Linguistics'">2004 - Linguistics</xsl:if>
<xsl:if test="FOR_code = '2005 - Literary Studies'">2005 - Literary Studies</xsl:if>
<xsl:if test="FOR_code = '2099 - Other Language, Communication and Culture'">2099 - Other Language, Communication and Culture</xsl:if>
<xsl:if test="FOR_code = '2101 - Archaeology'">2101 - Archaeology</xsl:if>
<xsl:if test="FOR_code = '2102 - Curatorial and Related Studies'">2102 - Curatorial and Related Studies</xsl:if>
<xsl:if test="FOR_code = '2103 - Historical Studies'">2103 - Historical Studies</xsl:if>
<xsl:if test="FOR_code = '2199 - Other History and Archaeology'">2199 - Other History and Archaeology</xsl:if>
<xsl:if test="FOR_code = '2201 - Applied Ethics'">2201 - Applied Ethics</xsl:if>
<xsl:if test="FOR_code = '2202 - History and Philosophy of Specific Fields'">2202 - History and Philosophy of Specific Fields</xsl:if>
<xsl:if test="FOR_code = '2203 - Philosophy'">2203 - Philosophy</xsl:if>
<xsl:if test="FOR_code = '2204 - Religion and Religious Studies'">2204 - Religion and Religious Studies</xsl:if>
<xsl:if test="FOR_code = '2299 - Other Philosophy and Religious Studies'">2299 - Other Philosophy and Religious Studies</xsl:if>
...
<note type="anzsrc_FOR_field_of_research_code">
<xsl:if test="//*[local-name()=$FOR_code] = '0101 - Pure Mathematics'">0101 - Pure Mathematics</xsl:if>
<xsl:if test="//*[local-name()=$FOR_code] = '